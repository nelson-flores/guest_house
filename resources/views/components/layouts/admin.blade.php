...
<html lang="en" class="no-focus">
    <head>
        ...
        <link rel="shortcut icon" href="{{ url('a_assets/media/favicons/favicon.png') }}">
        <!-- END Icons -->
        ...
        <!-- <link rel="stylesheet" id="css-theme" href="{{ url('a_assets/css/themes/flat.min.css') }}"> -->
        <link rel="stylesheet" id="css-theme" href="{{ url('a_assets/css/themes/pulse.min.css') }}">
    ...
    <body>
        ...
        <!-- Page JS Plugins -->
        <script src="{{ url('a_assets/js/plugins/chartjs/Chart.bundle.min.js') }}"></script>

        <!-- Page JS Code -->
        <script src="{{ url('a_assets/js/pages/db_corporate.min.js') }}"></script>
    </body>
</html>