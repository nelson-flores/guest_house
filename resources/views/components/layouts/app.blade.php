...
<body>
   <div class="kingho_body_wrapper">
      ...
      <header class="kingho_header header-alt_s1 alt_s2">
         ...
         <div class="theme__container">
            <div class="text-center">
               <div class="logo_area kingho_default_logo">
                  <div class="logo"><a href="{{ route('web.public.home') }}"><img src="assets/images/logo.png" alt=""></a></div>
               </div>
            </div>
         </div>
         ...
         <div class="kingho_sticky_header">
            <div class="kingho_header_middle">
               <div class="theme__container">
                  <div class="inner-container">
                     <div class="nav-outer">
                     ...
                     <div class="right_column">
                        <div class="kingho_search_button"><i class="far fa-search"></i></div>
                        <div class="menu-bar kingho_side_menu_button"><img src="assets/images/icons/icon-bar3.png"
                              alt=""></div>
                     </div>
                  </div>
               </div>
      ...
      <section class="page-title" style="background-image: url(assets/images/main-slider/about.jpg);">
         <div class="theme__container">
            <div class="content-box">
               <div class="content-wrapper">
                  <ul class="bread-crumb">
                     <li><a href="{{ route('web.public.home') }}">Pagina Inicial</a></li>
                     <li>{{ $title ?? '' }}</li>
                  </ul>
                  <div class="title">
                     <h1>{{ $title ?? '' }}</h1>
      ...
      {{ $slot }}
        ...
        <footer class="kingho_footer alt_s2" style="background-image: url(assets/images/background/bg-1.jpg); background-size:cover">
