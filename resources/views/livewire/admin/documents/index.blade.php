                ...
                <div class="col-12">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <div class="block">
                                <div class="block-header">
                                    <h3 class="block-title">Novo Documento</h3>
                                </div>
                                    ...
                                    <form action="#" method="POST" wire:submit.prevent='save()'   enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="name"
                                                placeholder="Nome da Documento" wire:model="name">
                                        </div>
                                        <div class="form-group pt-4">
                                            <button class="btn btn-info btn-sm">Salvar Documento</button>
                                        </div>
                                ...
                                <table class="table table-sm table-striped table-vcenter">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="be_pages_generic_profile.html" class="d-block">{{ $item->original_name
                                                    }}</a>
                                                <div class="btn-group">
                                                    <a href="{{ url($item->file_path) }}" target="_blank" class="btn btn-sm btn-success" title="Download">
