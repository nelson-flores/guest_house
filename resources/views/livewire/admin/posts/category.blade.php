<div>
    ...
    <form action="#" method="POST" wire:submit.prevent='save()'>
                                        ...
                                        <div class="form-group">
                                            <label for="excerpt" class="form-label">Categoria Superior</label>
                                            <select class="form-control" id="excerpt" wire:model="excerpt">
                                                <option value="">Selecione uma categoria superior</option>
                                        ...
                                        <div class="form-group pt-4">
                                            <button class="btn btn-info btn-sm">Salvar Categoria</button>
                                        </div>
            ...
            <div class="table-responsive">
                ...
                {{ $this->categories->links('livewire::bootstrap') }}
            </div>
